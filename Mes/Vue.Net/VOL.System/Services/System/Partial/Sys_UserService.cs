...
namespace VOL.System.Services
{
    public partial class Sys_UserService
    {
        ...
        public WebResponseContent Permission(User sendData)
        {
            var userData = repository.Find(c=>c.UserName == sendData.Name && c.UserPwd == sendData.Pwd.EncryptDES(AppSetting.Secret.User)).FirstOrDefault();
            if (userData != null)
                return userData.Confirm == 1 ?  new WebResponseContent(true) :  new WebResponseContent(false);
            else
