  ...
  <div class="vol-table"
    ...
    <el-table :show-summary="summary"
      ...
      <el-table-column v-for="(column, cindex) in filterColumns"
        ...
        <template #header>
          <span v-if="(column.require || column.required) && column.edit"
                class="column-required">*</span>{{ column.title }}
        </template>
        ...
        <template #default="scope">
          ...
          <el-table-column style="border: none"
            ...
            <template #scope1>
              <a href="javascript:void(0)"
                 ...
                 v-if="column.link"
                 v-text="scope1.row[columnChildren.field]"></a>
              <div v-else-if="columnChildren.formatter"
                   @click="
          ...
          <div v-else-if="
            ...
            <div @click.stop
              ...
              <div>
                ...
                <el-switch v-else-if="column.edit.type == 'switch'"
                           v-model="scope.row[column.field]"
                           active-color="#0f84ff"
                ...
                <el-select size="default"
                  ...
                  "
                           clearable>
                  <el-option v-for="item in column.bind.data"
                             :key="item.key"
                             v-show="!item.hidden"
                ...
                <el-input v-else-if="column.edit.type == 'textarea'"
                          type="textarea"
                          :placeholder="column.placeholder || column.title"
                          v-model="scope.row[column.field]">
                </el-input>
                ...
                <el-input v-else
                          ...
                          size="default"
                          v-model="scope.row[column.field]"
                          :placeholder="column.placeholder || column.title"></el-input>
              </div>
              <div class="extra"
                ...
                <a :style="column.extra.style"
                  ...
                  <i v-if="column.extra.icon"
                     :clss="[column.extra.icon]" />
                  {{ column.extra.text }}
                </a>
              </div>
            </div>
          ...
          <template v-else>
            ...
            <template v-else-if="column.bind">
              <el-tag :class="[isEmptyTag(scope.row, column)]"
                      :type="getColor(scope.row, column)"
                      :effect="column.effect">{{ formatter(scope.row, column, true) }}</el-tag>
            </template>
    ...
    <template v-if="!paginationHide">
      <div class="block pagination"
        ...
        <el-pagination key="pagination-02"
